...
class CartItemSchema(BaseModel):
    ...
    movie: MovieInCart = Field(
        ..., description="The movie details for the item in the cart."
    )
    added_at: datetime = Field(
        ..., description="The date and time the movie was added to the cart."
    )
...
class CartSchema(BaseModel):
    ...
    items: List[CartItemSchema] = Field(
        ..., description="A list of all items currently in the cart."
    )
...
class CartResponse(BaseModel):
    ...
    message: str = Field(
        ..., description="A message confirming the result of the operation."
    )
